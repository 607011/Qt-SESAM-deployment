...
"""
	...
	This script builds portable and installable editions of Qt-SESAM.
...
SRCDIR = "..\\..\\Qt-SESAM"
BUILD_CHROME_EXT = False # set to True for v2.5.x-DEV or later
...
def copy_files():
	...
	if not os.path.exists(DESTDIR + "\\platforms"):
		os.mkdir(DESTDIR + "\\platforms")
